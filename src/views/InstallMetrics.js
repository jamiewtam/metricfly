                  ...
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">Merchant Count</p>
              ...
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">Net Change</p>
              ...
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">Lifetime</p>
                        <CardTitle tag="h3">100 Days</CardTitle>
                      </div>
                    </Col>
                  </Row>
                </CardBody>
                <CardFooter>
                  <hr />
                  <div className="stats">Avg. Merchant Install Length</div>
                </CardFooter>
              </Card>
            </Col>
            <Col lg="3" md="6">
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">Reactivations</p>
                ...
                <CardFooter>
                  <hr />
                  <div className="stats">Merchants Who Installed Again</div>
                </CardFooter>
              </Card>
            </Col>
            <Col lg="3" md="6">
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">Up/Down</p>
                ...
                <CardFooter>
                  <hr />
                  <div className="stats">Net Plan Upgrades/Downgrades</div>
                </CardFooter>
              </Card>
            </Col>
            <Col lg="3" md="6">
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">User Churn (%)</p>
                        <CardTitle tag="h3">150GB</CardTitle>
                      </div>
                    </Col>
                  </Row>
                ...
                <CardFooter>
                  <hr />
                  <div className="stats">Uninstalls / Installs</div>
                </CardFooter>
              </Card>
            </Col>
            {/* <Col lg="4">
